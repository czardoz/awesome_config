...
myawesomemenu = {
  ...
  {"edit theme",            "terminal -x vim /home/rom/.config/awesome/themes/powerarrow-dark/theme.lua"},
...
'<span background="#313131" font="Terminus 12"> <span font="Terminus 9">$2% · $3% </span></span>', 3)
...
'<span background="#313131" font="Terminus 12"> <span font="Terminus 9">${/mnt/storage avail_gb}GB </span></span>', 8)
...
mywibox[s].widgets = {
   { mylauncher, mytaglist[s], mypromptbox[s], layout = awful.widget.layout.horizontal.leftright },
     ...
     arrl,
     spr,
     s == 1 and mysystray, spr, arrl or nil, mytasklist[s], 
...
awful.key({ modkey },            "p",        function () awful.util.spawn_with_shell("~/Tools/pycharm.run") end),
awful.key({ modkey },            "i",        function () awful.util.spawn_with_shell("~/Tools/idea.run") end),
